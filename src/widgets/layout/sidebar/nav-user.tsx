      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <div className="w-full relative max-w-85 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden cursor-pointer">
              ...
              <div className="px-5 pb-5 relative bg-[#faf9f6]">
                ...
                {/* Bio */}
                <p className="text-[15px] text-gray-800 mt-1 leading-snug line-clamp-2">
                  {headline}
                </p>
                {/* Location */}
